document.addEventListener('DOMContentLoaded', () => {
    ...
    const numSent = document.getElementById('btnBhNum');
    ...
    function easy() {
        ...
        function ckeckEasy() {
            ...
            numSent.textContent = `The Number was  ${randInt10}`;
    ...
    function medium() {
        ...
        function ckeckMedium() {
            ...
            numSent.textContent = `The Number was  ${randInt50}`;
    ...
    function hard() {
        ...
        function ckeckHard() {
            ...
            numSent.textContent = `The Number was  ${randInt100}`;
